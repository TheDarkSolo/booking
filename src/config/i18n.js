...
i18n.use(initReactI18next).init({
  ...
  resources: {
    ru: {
      translation: {
        title: "Бронирование очереди на услуги ЦОН",
        menu: [
          {
            id: 1,
        ...
        //TRIAL PRACTICE TRANSLATIONS
        trialReserveAgain: "Забронировать еще раз",
        ...
        //TRIAL THEORY TRANSLATIONS
        btn_title_reservation_trialTheory_exam: "Пробный теоретический экзамен",
        titlePageTrialTheory: "Сдача пробного теоретического экзамена",
        devProcess: "Данная услуга находится на стадии разработки. Совсем скоро вы сможете подготовиться к экзамену в удобное для вас время. Следите за обновлениями на нашем сайте!",
      },
    },
    kz: {
      translation: {
        title: "ХҚКО қызметтеріне кезекті брондау", 
        menu: [
          {
            id: 1,
        ...
        //TRIAL PRACTICE TRANSLATIONS
        trialReserveAgain: "Қайта брондау",
        ...
        //TRIAL THEORY TRANSLATIONS
        btn_title_reservation_trialTheory_exam: "Сынамалы теориялық емтихан",
        titlePageTrialTheory: "Сынамалы теориялық емтиханды тапсыру",
        devProcess: "Бұл қызмет даму сатысында. Жақында сіз өзіңізге ыңғайлы уақытта емтиханға дайындала аласыз. Біздің сайттағы жаңартуларды қадағалаңыз!",
      },
    },
  },
});
